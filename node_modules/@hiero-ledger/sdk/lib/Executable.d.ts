...
export default class Executable<RequestT, ResponseT, OutputT> {
     ...
     * @returns {this}
     */
    setMaxRetries(maxRetries: number | null): this;
    /**
     ...
     * @returns {this}
     */
    setMaxAttempts(maxAttempts: number | null): this;
    /**
     ...
     */
    protected _getStatusAndExecutionState(request: RequestT, response: ResponseT): [Status, ExecutionState];
    /**
     ...
     * @returns {boolean}
     */
    private _shouldRetryRequestError;
    /**
     ...
     * @returns {void}
     */
    private _validateTransactionNodeIds;
    /**
     * @private
     ...
     * @returns {boolean}
     */
    private _shouldSkipAttemptForNodeAccountId;
    /**
     * @private
     ...
     * @returns {Promise<void>}
     */
    private _handleInvalidNodeAccountId;
    /**
     * @private
     * @param {Channel} channel
     * @param {RequestT} request
     * @returns {Promise<ResponseT>}
     */
    private _executeRequestWithGrpcDeadline;
    /**
