...
export default class NodeUpdateTransaction extends Transaction {
    ...
    constructor(props?: {
        ...
        associatedRegisteredNodes?: (number | Long)[] | null | undefined;
    });
    /**
     * @private
     * @type {?Long}
     ...
     */
    private _associatedRegisteredNodes;
    /**
     * @param {Long} nodeId
     ...
     * @returns {NodeUpdateTransaction}
     */
    setAssociatedRegisteredNodes(registeredNodeIds: Array<Long | number>): NodeUpdateTransaction;
    /**
     * @param {Long | number} registeredNodeId
     * @returns {NodeUpdateTransaction}
     */
    addAssociatedRegisteredNode(registeredNodeId: Long | number): NodeUpdateTransaction;
    /**
     * @returns {NodeUpdateTransaction}
     */
    clearAssociatedRegisteredNodes(): NodeUpdateTransaction;
    /**
     * @returns {?Array<Long>}
     */
    get associatedRegisteredNodes(): Array<Long> | null;
    /**
...
export type IAssociatedRegisteredNodeList = import("@hiero-ledger/proto").com.hedera.hapi.node.addressbook.IAssociatedRegisteredNodeList;
