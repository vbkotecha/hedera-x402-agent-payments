...
function _toAssociatedRegisteredNodeId(registeredNodeId) {
  ...
  if (longRegisteredNodeId.toNumber() < 0) {
    throw new Error("NodeCreateTransaction: associated registered node IDs must be positive.");
  }
...
class NodeCreateTransaction extends _Transaction.default {
  ...
  constructor(props) {
     ...
     */
    this._associatedRegisteredNodes = props?.associatedRegisteredNodes != null ? props.associatedRegisteredNodes.map(_toAssociatedRegisteredNodeId) : [];
  }
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new NodeCreateTransaction({
      ...
      associatedRegisteredNodes: nodeCreate.associatedRegisteredNode != null ? nodeCreate.associatedRegisteredNode.map(_toAssociatedRegisteredNodeId) : undefined,
