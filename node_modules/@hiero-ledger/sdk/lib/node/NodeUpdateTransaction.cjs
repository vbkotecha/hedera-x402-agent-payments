...
function _toAssociatedRegisteredNodeId(registeredNodeId) {
  const longRegisteredNodeId = _long.default.isLong(registeredNodeId) ? registeredNodeId : _long.default.fromValue(registeredNodeId);
  if (longRegisteredNodeId.toNumber() < 0) {
    throw new Error("NodeUpdateTransaction: associated registered node IDs must be positive.");
  }
...
class NodeUpdateTransaction extends _Transaction.default {
  ...
  constructor(props) {
     ...
     */
    this._associatedRegisteredNodes = props?.associatedRegisteredNodes != null ? props.associatedRegisteredNodes.map(_toAssociatedRegisteredNodeId) : null;
  }
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new NodeUpdateTransaction({
      ...
      associatedRegisteredNodes: nodeUpdate.associatedRegisteredNodeList != null ? nodeUpdate.associatedRegisteredNodeList.associatedRegisteredNode != null ? nodeUpdate.associatedRegisteredNodeList.associatedRegisteredNode.map(_toAssociatedRegisteredNodeId) : [] : undefined
  ...
  setAssociatedRegisteredNodes(registeredNodeIds) {
    this._requireNotFrozen();
    this._associatedRegisteredNodes = registeredNodeIds.map(_toAssociatedRegisteredNodeId);
    return this;
  }
  ...
  addAssociatedRegisteredNode(registeredNodeId) {
    ...
    this._associatedRegisteredNodes.push(_toAssociatedRegisteredNodeId(registeredNodeId));
    return this;
  }
  ...
  _makeTransactionData() {
    ...
    const associatedRegisteredNodeList = this._associatedRegisteredNodes != null ? {
