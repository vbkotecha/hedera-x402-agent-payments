...
var _RegisteredServiceEndpoint = _interopRequireDefault(require("./RegisteredServiceEndpoint.cjs"));
 ...
 *   `setDescription("")`.
 */
class RegisteredNodeUpdateTransaction extends _Transaction.default {
  /**
   * @param {object} [props]
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const registeredNodeUpdate = /** @type {IRegisteredNodeUpdateTransactionBody} */
    body.registeredNodeUpdate;
    return _Transaction.default._fromProtobufTransactions(new RegisteredNodeUpdateTransaction({
      registeredNodeId: registeredNodeUpdate.registeredNodeId != null ? _long.default.fromValue(registeredNodeUpdate.registeredNodeId) : undefined,
      adminKey: registeredNodeUpdate.adminKey != null ? _Key.default._fromProtobufKey(registeredNodeUpdate.adminKey) : null,
      description: registeredNodeUpdate.description != null && Object.hasOwn(registeredNodeUpdate.description, "value") ? registeredNodeUpdate.description.value : null,
      serviceEndpoints: registeredNodeUpdate.serviceEndpoint != null && registeredNodeUpdate.serviceEndpoint.length > 0 ? registeredNodeUpdate.serviceEndpoint.map(endpoint => _RegisteredServiceEndpoint.default._fromProtobuf(endpoint)) : null
  ...
  setRegisteredNodeId(registeredNodeId) {
    ...
    if (registeredNodeId == null) {
      throw new TypeError("registeredNodeId must not be null or undefined.");
    }
    this._registeredNodeId = _long.default.isLong(registeredNodeId) ? registeredNodeId : _long.default.fromValue(registeredNodeId);
    return this;
  }
  ...
  setServiceEndpoints(serviceEndpoints) {
    ...
    if (serviceEndpoints == null) {
      throw new TypeError("serviceEndpoints must not be null or undefined.");
    }
  ...
  get serviceEndpoints() {
    return this._serviceEndpoints != null ? [...this._serviceEndpoints] : null;
  }
  ...
  addServiceEndpoint(serviceEndpoint) {
    ...
    if (serviceEndpoint == null) {
      throw new TypeError("serviceEndpoint must not be null or undefined.");
    }
  ...
  _makeTransactionData() {
    ...
    const data = {
      registeredNodeId: this._registeredNodeId != null ? this._registeredNodeId : null,
      ...
      serviceEndpoint: this._serviceEndpoints != null ? this._serviceEndpoints.map(endpoint => endpoint._toProtobuf()) : null
    };
    return data;
  }
...
exports.default = RegisteredNodeUpdateTransaction;
_Transaction.TRANSACTION_REGISTRY.set("registeredNodeUpdate",
