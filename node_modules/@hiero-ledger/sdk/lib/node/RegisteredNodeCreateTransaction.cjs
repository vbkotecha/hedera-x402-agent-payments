 ...
 */
class RegisteredNodeCreateTransaction extends _Transaction.default {
  /**
   * @param {object} [props]
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const registeredNodeCreate = /** @type {IRegisteredNodeCreateTransactionBody} */
    body.registeredNodeCreate;
    return _Transaction.default._fromProtobufTransactions(new RegisteredNodeCreateTransaction({
      adminKey: registeredNodeCreate.adminKey != null ? _Key.default._fromProtobufKey(registeredNodeCreate.adminKey) : null,
      description: registeredNodeCreate.description != null ? registeredNodeCreate.description : null,
      serviceEndpoints: registeredNodeCreate.serviceEndpoint != null ? registeredNodeCreate.serviceEndpoint.map(endpoint => _RegisteredServiceEndpoint.default._fromProtobuf(endpoint)) : []
  ...
  _makeTransactionData() {
    ...
    const data = {
      ...
      serviceEndpoint: this._serviceEndpoints.map(endpoint => endpoint._toProtobuf())
    };
    return data;
  }
...
exports.default = RegisteredNodeCreateTransaction;
_Transaction.TRANSACTION_REGISTRY.set("registeredNodeCreate",
