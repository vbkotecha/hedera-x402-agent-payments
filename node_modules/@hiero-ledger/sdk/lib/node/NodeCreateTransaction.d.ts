...
export default class NodeCreateTransaction extends Transaction {
    ...
    constructor(props?: {
        ...
        associatedRegisteredNodes?: (number | Long)[] | undefined;
    });
    /**
     * @private
     * @type {?AccountId}
     ...
     * @returns {NodeCreateTransaction}
     */
    setAssociatedRegisteredNodes(registeredNodeIds: Array<Long | number>): NodeCreateTransaction;
    /**
     * @param {Long | number} registeredNodeId
     * @returns {NodeCreateTransaction}
     */
    addAssociatedRegisteredNode(registeredNodeId: Long | number): NodeCreateTransaction;
    /**
     * @returns {Array<Long>}
     */
    get associatedRegisteredNodes(): Array<Long>;
    /**
     * @override
     * @protected
