...
var _RegisteredServiceEndpoint = _interopRequireWildcard(require("./RegisteredServiceEndpoint.cjs"));
 ...
 */
class RpcRelayServiceEndpoint extends _RegisteredServiceEndpoint.default {
  /**
  ...
  static _fromProtobuf(endpoint) {
    return new RpcRelayServiceEndpoint({
      ...
      domainName: endpoint.domainName != null ? endpoint.domainName : null,
      port: endpoint.port != null ? endpoint.port : null,
      requiresTls: endpoint.requiresTls != null ? endpoint.requiresTls : null
    });
  }
...
exports.default = RpcRelayServiceEndpoint;
_RegisteredServiceEndpoint.ENDPOINT_FROM_PROTOBUF_REGISTRY.set("rpcRelay",
// eslint-disable-next-line @typescript-eslint/unbound-method
RpcRelayServiceEndpoint._fromProtobuf);
_RegisteredServiceEndpoint.ENDPOINT_FROM_JSON_REGISTRY.set("rpcRelay",
// eslint-disable-next-line @typescript-eslint/unbound-method
