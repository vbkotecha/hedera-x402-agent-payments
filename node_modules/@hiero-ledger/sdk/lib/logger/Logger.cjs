...
class Logger {
   ...
   */
  constructor(levelOrOptions, logFile = "", sync = true, fsync = true, mkdir = true, minLength = 0) {
    /** @type {LogLevel} */
    let level;
    /** @type {boolean} */
    let silent;
    if (typeof levelOrOptions === "object" && levelOrOptions !== null && !(levelOrOptions instanceof _LogLevel.default)) {
