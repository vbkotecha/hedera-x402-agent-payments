...
class EvmHookMappingEntry {
  ...
  static _fromProtobuf(hookMappingEntry) {
    return new EvmHookMappingEntry({
      key: hookMappingEntry.key != null ? hookMappingEntry.key : undefined,
      value: hookMappingEntry.value != null ? hookMappingEntry.value : undefined,
      preimage: hookMappingEntry.preimage != null ? hookMappingEntry.preimage : undefined
    });
  }
...
var _default = exports.default = EvmHookMappingEntry;