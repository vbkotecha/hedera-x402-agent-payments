...
var _HookEntityId = _interopRequireDefault(require("./HookEntityId.cjs"));
...
class HookId {
  ...
  static _fromProtobuf(hookId) {
    return new HookId({
      entityId: hookId.entityId != null ? _HookEntityId.default._fromProtobuf(hookId.entityId) : undefined,
  ...
  _toProtobuf() {
    return {
      entityId: this._entityId != null ? this._entityId._toProtobuf() : null,
      hookId: this._hookId
    };
  }
}
var _default = exports.default = HookId;