...
class FreezeTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(freezeTransaction, transactions, signedTransactions, transactionIds, nodeIds, bodies);
  }
   ...
   */
  get endTime() {
    console.warn("`FreezeTransaction.endTime` is deprecated: the network ignores this field and there is no replacement");
