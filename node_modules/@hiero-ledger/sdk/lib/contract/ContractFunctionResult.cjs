...
const defaultAbiCoder = _ethers.AbiCoder.defaultAbiCoder();
/**
...
class ContractFunctionResult {
   ...
   */
  getInt40(index) {
    const result = defaultAbiCoder.decode(["int40"], this._getBytes32(index != null ? index : 0));
   ...
   */
  getInt48(index) {
    const result = defaultAbiCoder.decode(["int48"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt56(index) {
    const result = defaultAbiCoder.decode(["int56"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt64(index) {
    const result = defaultAbiCoder.decode(["int64"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt72(index) {
    const result = defaultAbiCoder.decode(["int72"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt80(index) {
    const result = defaultAbiCoder.decode(["int80"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt88(index) {
    const result = defaultAbiCoder.decode(["int88"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt96(index) {
    const result = defaultAbiCoder.decode(["int96"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt104(index) {
    const result = defaultAbiCoder.decode(["int104"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt112(index) {
    const result = defaultAbiCoder.decode(["int112"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt120(index) {
    const result = defaultAbiCoder.decode(["int120"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt128(index) {
    const result = defaultAbiCoder.decode(["int128"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt136(index) {
    const result = defaultAbiCoder.decode(["int136"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt144(index) {
    const result = defaultAbiCoder.decode(["int144"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt152(index) {
    const result = defaultAbiCoder.decode(["int152"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt160(index) {
    const result = defaultAbiCoder.decode(["int160"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt168(index) {
    const result = defaultAbiCoder.decode(["int168"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt176(index) {
    const result = defaultAbiCoder.decode(["int176"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt184(index) {
    const result = defaultAbiCoder.decode(["int184"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt192(index) {
    const result = defaultAbiCoder.decode(["int192"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt200(index) {
    const result = defaultAbiCoder.decode(["int200"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt208(index) {
    const result = defaultAbiCoder.decode(["int208"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt216(index) {
    const result = defaultAbiCoder.decode(["int216"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt224(index) {
    const result = defaultAbiCoder.decode(["int224"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt232(index) {
    const result = defaultAbiCoder.decode(["int232"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt240(index) {
    const result = defaultAbiCoder.decode(["int240"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt248(index) {
    const result = defaultAbiCoder.decode(["int248"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
   ...
   */
  getInt256(index) {
    const result = defaultAbiCoder.decode(["int256"], this._getBytes32(index != null ? index : 0));
    return new _bignumber.default(result.toString());
  }
  ...
  _convertEthersValue(value, type) {
    const typeStr = typeof type === "string" ? type : type.type || String(type);
