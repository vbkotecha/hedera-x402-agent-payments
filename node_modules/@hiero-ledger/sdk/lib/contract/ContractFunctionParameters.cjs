    ...
    case _ContractFunctionSelector.ArgumentType.uint256:
      {
        ...
        const encodedData = defaultAbiCoder.encode([(0, _ContractFunctionSelector.solidityTypeToString)(ty)], [paramToHex]);
        const dataToArrayify = (0, _ethers.getBytes)(encodedData);
