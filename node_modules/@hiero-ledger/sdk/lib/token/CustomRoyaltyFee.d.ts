...
export default class CustomRoyaltyFee extends CustomFee {
     ...
     */
    setFallbackFee(fallbackFee: CustomFixedFee): CustomRoyaltyFee;
    /**
     * @returns {?Long}
     */
     ...
     * @returns {CustomRoyaltyFee}
     */
    setNumerator(numerator: Long | number): CustomRoyaltyFee;
    /**
     * @returns {?Long}
     */
     ...
     * @returns {CustomRoyaltyFee}
     */
    setDenominator(denominator: Long | number): CustomRoyaltyFee;
}
