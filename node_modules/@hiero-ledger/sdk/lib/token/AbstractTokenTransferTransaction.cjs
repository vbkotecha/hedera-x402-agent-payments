...
class AbstractTokenTransferTransaction extends _Transaction.default {
   ...
   * @returns {this}
   */
  _addTokenTransfer(tokenId, accountId, amount, isApproved, expectedDecimals, hookCall) {
   ...
   * @returns {this}
   */
  _addNftTransfer(isApproved, tokenIdOrNftId, senderAccountIdOrSerialNumber, receiverAccountIdOrSenderAccountId, receiver, senderHookCall, receiverHookCall) {
    this._requireNotFrozen();
    let nftId;
    let senderAccountId;
