...
export default class TransferTransaction extends AbstractTokenTransferTransaction {
     ...
     * @returns {TransferTransaction}
     */
    _addHbarTransfer(accountId: AccountId | string, amount: number | string | Long | LongObject | BigNumber | Hbar, isApproved: boolean, hookCall?: FungibleHookCall): TransferTransaction;
    /**
     * @internal
     * @param {AccountId | string} accountId
     * @param {number | string | Long | LongObject | BigNumber | Hbar} amount
     ...
     * @returns {TransferTransaction}
     */
    addHbarTransferWithHook(accountId: AccountId | string, amount: number | string | Long | LongObject | BigNumber | Hbar, hook: FungibleHookCall): TransferTransaction;
    /**
     * @param {NftId | string} nftId
     ...
     * @returns {TransferTransaction}
     */
    addNftTransferWithHook(nftId: NftId | string, sender: AccountId | string, receiver: AccountId | string, senderHookCall: NftHookCall, receiverHookCall: NftHookCall): TransferTransaction;
    /**
     * @param {TokenId | string} tokenId
     * @param {AccountId | string} accountId
     ...
     * @returns {TransferTransaction}
     */
    addTokenTransferWithHook(tokenId: TokenId | string, accountId: AccountId | string, amount: number | bigint | Long | BigNumber, hook: FungibleHookCall): TransferTransaction;
    /**
     * @override
     * @protected
...
export namespace HieroProto {
    namespace proto {
        ...
        type ICryptoTransferTransactionBody = import("@hiero-ledger/proto").proto.ICryptoTransferTransactionBody;
    }
}
...
export type NftHookCall = import("../hooks/NftHookCall.js").default;
