...
declare namespace Status {
    ...
    let PendingAirdropIdListTooLong: Status;
    ...
    let EvmHookStorageUpdateBytesTooLong: Status;
    let EvmHookStorageUpdateBytesMustUseMinimalRepresentation: Status;
    let InvalidHookId: Status;
    let EmptyEvmHookStorageUpdate: Status;
    let HookIdRepeatedInCreationDetails: Status;
    let HooksNotEnabled: Status;
    let HookIsNotAnEvmHook: Status;
    let HookDeleted: Status;
    let TooManyEvmHookStorageUpdates: Status;
    ...
    let TransferToFeeCollectionAccountNotAllowed: Status;
    let TooManyHookInvocations: Status;
    let InvalidRegisteredNodeId: Status;
    let InvalidRegisteredEndpoint: Status;
    let RegisteredEndpointsExceededLimit: Status;
    let InvalidRegisteredEndpointAddress: Status;
    let InvalidRegisteredEndpointType: Status;
    let RegisteredNodeStillAssociated: Status;
    let MaxRegisteredNodesExceeded: Status;
}
