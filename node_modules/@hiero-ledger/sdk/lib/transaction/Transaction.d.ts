...
export default class Transaction extends Executable<HieroProto.proto.ITransaction, HieroProto.proto.ITransactionResponse, TransactionResponse> {
     ...
     * @returns {void}
     */
    private static _validateChunkedTransactionBodies;
    /**
     ...
     * @returns {Set<string>}
     */
    private static _getChunkedTransactionIgnoredFields;
    /**
     ...
     * @returns {this}
     */
    setHighVolume(highVolume: boolean): this;
    /**
     ...
     * @returns {Promise<this>}
     */
    signWithOperator(client: Client): Promise<this>;
    /**
     ...
     * @param {?Client} client
     */
    _setNodeAccountIds(client: Client | null): void;
    /**
