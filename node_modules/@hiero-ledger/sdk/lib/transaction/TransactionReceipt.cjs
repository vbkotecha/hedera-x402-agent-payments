...
class TransactionReceipt {
  ...
  static _fromProtobuf(response) {
    ...
    return new TransactionReceipt({
      ...
      registeredNodeId: receipt.registeredNodeId != null && !_long.default.fromValue(receipt.registeredNodeId).isZero() ? _long.default.fromValue(receipt.registeredNodeId) : null,
