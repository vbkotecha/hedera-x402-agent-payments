...
class TransactionRecord {
  ...
  constructor(props) {
     ...
     * @readonly
     */
    this.highVolumePricingMultiplier = _long.default.fromValue(props.highVolumePricingMultiplier ?? _long.default.UZERO);
    Object.freeze(this);
  }
  ...
  _toProtobuf() {
    ...
    return {
      ...
      transactionRecord: {
        ...
        highVolumePricingMultiplier: !this.highVolumePricingMultiplier.isZero() ? this.highVolumePricingMultiplier : null
      }
    };
  }
  ...
  static _fromProtobuf(response) {
    ...
    const highVolumePricingMultiplier = /** @type {Long | null | undefined} */record.highVolumePricingMultiplier ?? _long.default.UZERO;
  ...
  toJSON() {
    return {
      ...
      highVolumePricingMultiplier: this.highVolumePricingMultiplier.toString()
    };
  }
