    ...
    if (typeof network === "string") {
      ...
      for (const [key] of Object.entries(network)) {
        if (key.startsWith("https://") || key.startsWith("http://")) {
          console.warn('[Deprecation Notice] Hiero SDK: Network endpoint "' + key + '" includes a URL scheme (e.g. "https://"). ' + "This format was accepted in earlier versions but is now deprecated. " + 'Please remove the scheme and use "host:port" instead (e.g. "node00.swirldslabs.com:443"). ' + "Support for scheme-prefixed endpoints will be removed in a future major release.");
        }
      }
