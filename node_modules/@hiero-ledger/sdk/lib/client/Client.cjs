...
class Client {
  ...
  constructor(props) {
    ...
    /** @type {number} */
    this._maxAttempts = props != null && this._isLocalNetwork(props.network) ? _ClientConstants.DEFAULT_LOCAL_MAX_ATTEMPTS : _ClientConstants.DEFAULT_MAX_ATTEMPTS;
  ...
  _isLocalNetwork(network = this.network) {
    ...
    return Object.keys(network).some(key => key.includes("127.0.0.1") || key.includes("localhost"));
  }
